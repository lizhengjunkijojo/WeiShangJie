package com.lzj.vtm.demo.fun.juhe.pcd.adapter;
 ...
 *
 */
public class PCDListAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<City> images;

    public PCDListAdapter() {
        this.images = new ArrayList<City>();
    }

    public void setImages(ArrayList<City> images) {
        this.images = images;
